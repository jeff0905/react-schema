...
import Editor from './g6/editor';
import G6Editor from '@antv/g6-editor';
import Navigator from './g6/Navigator';
import ToolBar from './g6/Toolbar';
import Contextmenu from './g6/ContextMenu.js';
import Page from './g6/Page.js';
import { Checkbox, Input, Button } from 'antd';
import './g6/editor.css';
import './g6/ModelFlowEditor.css';
      ...
      <div className="bottom-container">
        ...
        <div id="itempannel">
          <ul>
            ...
            <li className="getItem" data-shape="table" data-type="node" data-size="170*34">
              <span className="pannel-type-icon"></span>table
            </li>
          </ul>
        </div>
        <div id="detailpannel">
